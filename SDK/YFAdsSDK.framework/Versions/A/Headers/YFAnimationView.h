...
@interface YFAnimationView : LOTView
...
/// Creates an animation from the YFComposition, images are loaded from the specified bundle
- (nonnull instancetype)initWithModel:(nullable YFComposition *)model inBundle:(nullable NSBundle *)bundle;
...
/// Load animation by name from the default bundle. Use when loading YFAnimationView via Interface Builder.
...
@property (nonatomic, strong, nullable) YFComposition *sceneModel;
...
/*!
 ...
 See the documentation for YFValueDelegate to see how to create LOTValueCallbacks. A delegate can be any object that conforms to the YFValueDelegate protocol, or one of the prebuilt delegate classes found in LOTBlockCallback, LOTInterpolatorCallback, and LOTValueCallback.

 See the documentation for YFKeypath to learn more about how to create keypaths.
 ...
 */
- (void)setValueDelegate:(id<YFValueDelegate> _Nonnull)delegates
              forKeypath:(YFKeypath * _Nonnull)keypath;

/*!
 @brief returns the string representation of every keypath matching the YFKeypath search.
 */
...
/*!
 @brief Converts the given CGRect from the receiving animation view's coordinate space to the supplied layer's coordinate space If layerName is null then the rect will be converted to the composition coordinate system. This is helpful when adding custom subviews to a YFAnimationView
