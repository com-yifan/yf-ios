...
/** Category of additions for `<YFDatabase>` class.
...
@interface YFDatabase (FMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `YFResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (YFResultSet * _Nullable)getSchema;
...
- (YFResultSet * _Nullable)getTableSchema:(NSString*)tableName;
