...
@class YFAnimatedImage;
@protocol FLAnimatedImageViewDebugDelegate;


//
//  An `YFAnimatedImageView` can take an `YFAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface YFAnimatedImageView : UIImageView
...
@property (nonatomic, strong) YFAnimatedImage *animatedImage;
